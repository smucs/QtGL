...
void QGLWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData QGLWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QGLWindow::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_QGLWindow,
      qt_meta_data_QGLWindow, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QGLWindow::getStaticMetaObject() { return staticMetaObject; }
